                ...
                <form action="<?php echo BASE_URL ?>/giohang/updategiohang" method="POST">
                  ...
                  <tr class="tr">
                    ...
                    <td class="actions aligncenter">
                      ...
                      <button type="submit" style="box-shadow: none;" value="<?php echo $value['product_id'] ?>"
                        name="update_cart" class="btn btn-sm btn-primary">Cập nhật</button>
                    </td>
              ...
              <div class="ch-contacts-details">
                <ul class="contact-list">
                  <li class="addr">
                    ...
                    <p><em><strong>XTTTT</strong></em><br />
                    ...
                    <p> Hotline: 0948801548</p>
                    </p>
                  </li>
                </ul>
                <div class="hiring-box">
                  <strong class="title">Chào bạn!</strong>
                  <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi <strong>kytv.name.vn</strong> chúng tôi
                    sẽ giải đáp cho bạn.</p>
                  <p><a href="." class="arrow-link"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Về trang
                      chủ</a></p>
                </div>
              </div>
            </div>
