 ...
 <body>
     <header>
         <div class="info_top">
             <div class="bg_in">
                 <p class="p_infor">
                     <span><i class="fa fa-envelope-o" aria-hidden="true"></i>Email: abc@gmail.com</span>
                         ...
                         <div class="cart_wrapper">
                             <div class="cols_50">
                                 <div class="hot_line_top">
                                     ...
                                     <br />
                                     <span class="red">Công viên phần mềm Quang Trung, Quận 12, TP.HCM</span>
                                 </div>
                             </div>
                             <div class="cols_50">
                                 <div class="hot_line_top">
                             ...
                             <div id='cssmenu'>
                                 ...
                                 <ul>
                                     <?php
                                        ...
                                        ?>
                                         <li> <a href='<?php echo BASE_URL ?>/tintuc/danhmuc/<?php echo $cate_post['id_category_post'] ?>'><span><?php echo $cate_post['title_category_post'] ?></span></a>
                                         </li>
                                     <?php
                                        }
                                        ?>
