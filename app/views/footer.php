  <footer>
      ...
      <div class="bg_in">
        <div class="footer footer_bottom">
          ...
          <div class="footer-col">
            ...
            <div class="footer-col-content">
              <ul class="social">
                <li><a target="_blank" href="https://www.facebook.com/tranky1992/" class="fb"><img
                      src="<?php echo BASE_URL ?>/public/images/Fb.png">Facebook</a></li>
                <li><a target="_blank" href="https://www.youtube.com/channel/UCqLv5UwaAG5vIxrHHQYyWcQ" class="fb"><img
                      height="32" width="32" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
              </ul>
              <div class="clear"></div>
            </div>
          </div>
          <div class="footer-col">
            ...
            <div class="footer-col-content">
              <ul class="icon_list">
                ...
                <div class="clear"></div>
                <li><a><i class="fa fa-envelope" aria-hidden="true"></i> kytv.name.vn</a></li>
                <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i> http://kytv.name.vn/</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="clear"></div>
    <div class="copyright">
      <h4 class="tkw9999">&copy; © Bản quyền thuộc về KyTV. Designed by <a href="http://kytv.name.vn/" rel="dofollow"
          target="_blank">Thiet Ke Web</a> Bởi <a href="http://kytv.name.vn/">kytv.name.vn</a>
      </h4>
    </div>
  </footer>
  ...
  <script async defer crossorigin="anonymous"
    src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v9.0&appId=297476534767349&autoLogAppEvents=1"
    nonce="6Np37FtJ"></script>
